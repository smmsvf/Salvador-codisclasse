...
def grafica(llistapersones):   
    dades = llistapersones # Valors de les variables
    ...
    ax1.set_title('Grup de persones') # Titol del grafic
    ax1.set_xticks(ind) # Marques sota de cada diagrama
    ax1.yaxis.set_major_locator(plt.NullLocator())
    ax1.set_xticklabels(('')) # Text sota de cada diagrama en aquest cas HOMES i DONES.
    ax1.set_yticklabels([])
...
'''
grafica([23,45,10,50,32,12,45,32,5,17])
'''
